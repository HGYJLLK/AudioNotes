...
# from app.services import data_layer  # Disabled for local testing - Chainlit will use default local storage
...
# data_layer.init()  # Disabled for local testing - not needed without PostgreSQL
